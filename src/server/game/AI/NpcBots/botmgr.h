...
class BotMgr
{
    public:
        ...
        Creature* GetBot(ObjectGuid const& guid) const;
        ...
        void CleanupsBeforeBotDelete(ObjectGuid const& guid);
        void RemoveAllBots(uint8 removetype = BOT_REMOVE_LOGOUT);
        void RemoveBot(ObjectGuid const& guid, uint8 removetype = BOT_REMOVE_LOGOUT);
    ...
    private:
        ...
        void _addBotToRemoveList(ObjectGuid const& guid);
