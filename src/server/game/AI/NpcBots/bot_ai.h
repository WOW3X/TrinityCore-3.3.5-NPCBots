...
//    BOT_CLASS_BM,
    ...
    BOT_CLASS_NORMAL_END                = CLASS_DRUID, //BOT_CLASS_BM,
    BOT_CLASS_EX_START                  = BOT_CLASS_END, //BOT_CLASS_BM,
    BOT_CLASS_EX_END
};
...
class bot_ai : public ScriptedAI
{
    ...
    public:
        ...
        virtual const bot_minion_ai* GetMinionAI() const { return nullptr; }
    ...
    protected:
        ...
        inline bool IsChanneling(Unit* u = NULL) const { if (!u) u = me; return u->GetCurrentSpell(CURRENT_CHANNELED_SPELL) != nullptr; }
...
class bot_minion_ai : public bot_ai
{
    public:
        ...
        virtual void Reset() {}
        virtual void EnterEvadeMode(EvadeReason why = EVADE_REASON_OTHER) override { EnterEvadeMode(false); }
        ...
        //void CastBotItemCombatSpell(Unit* target, WeaponAttackType attType, uint32 procVictim, uint32 procEx, Spell const* spell = NULL) override;
		...
		void CastBotItemCombatSpell(DamageInfo const& damageInfo) override;
